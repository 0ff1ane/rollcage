...
config :api_server, ApiServer.Repo,
  ...
  password: "",
  hostname: "localhost",
  database: "rollcage_api_server_dev",
  stacktrace: true,
...
config :api_server, ApiServerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/api_server_web/router\.ex$",
      ~r"lib/api_server_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :api_server, dev_routes: true
